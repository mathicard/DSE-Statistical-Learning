...
After our analysis, we concluded that the AQI doesn't differ significantly in states where there has been a lockdown.
Especially through the boxplots and the ANOVA test, we see that there is no strong relation between lockdown and the AQI,
