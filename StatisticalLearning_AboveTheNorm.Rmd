...
Density Plot of our dependent variable
<br>
<center>
```{r message=FALSE}
library(ggplot2)
...
<center>
<br>
Test for Normality on the dependent variable tells us that we need a "more" normal distribution.
```{r}
